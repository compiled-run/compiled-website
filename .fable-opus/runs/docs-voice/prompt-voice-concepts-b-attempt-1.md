Fable-Opus-Unit: docs-voice/voice-concepts-b
Fable-Opus-Parallel: yes

## Goal

Retune the prose voice of three Markless docs pages. A previous pass already gave them bite-size rhythm; this pass adjusts REGISTER only. Most paragraphs need no change. Rewrite only where the register is off.
