Fable-Opus-Unit: docs-rhythm/concepts-a
...
- `/Users/jacksm5pro/dev/open-source/markless/.claude/worktrees/compiled-website/pages/markless/concepts/state.mdx`
- `/Users/jacksm5pro/dev/open-source/markless/.claude/worktrees/compiled-website/pages/markless/concepts/computed.mdx`
- `/Users/jacksm5pro/dev/open-source/markless/.claude/worktrees/compiled-website/pages/markless/concepts/events.mdx`
- `/Users/jacksm5pro/dev/open-source/markless/.claude/worktrees/compiled-website/pages/markless/concepts/conditionals.mdx`
...
Remove: citations of internal spec paths (`specs/framework/...`, `specs/router/...`) and phrases like "the specification says", including parenthetical citations like "(specs/framework/12-arm-rendering.md, the arm rendering ladder)". Keep the factual claim itself; drop the citation. If a blockquote quotes a spec verbatim, replace it with plain-language sentences carrying the same promise.
